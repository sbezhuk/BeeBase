...
/// already-uploaded media id to whichever of the two owns it. Media-service
/// no longer exposes a client-facing attach endpoint (see beebase-gateway's
/// internal-only routing), so attaching now means asking the owning
/// service to add the id to its own `images` - this interface just routes
/// to [IApiaryWriter.addApiaryImage]/[IHiveWriter.addHiveImage] by
