...
final class _ApiaryListLoadMoreError extends StatelessWidget {
  const _ApiaryListLoadMoreError();

  @override
  Widget build(BuildContext context) {
    final colors = context.colors;
    return InkWell(
      onTap: () => context.read<ApiaryListCubit>().retryLoadNextPage(),
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            SizedBox(width: context.spacing.sm),
            Text(
              'apiary.list.retry'.tr(),
              style: context.textStyles.body.copyWith(color: colors.brand.primary, fontWeight: FontWeight.w600),
            ),
          ],
        ),
      ),
