...
final class _OtpField extends StatelessWidget {
  ...
  String? _validate(String? value) {
    if (value == null || !RegExp(r'^[0-9]{6}$').hasMatch(value)) {
      return 'authentication.login_otp.validations.otp_invalid_format'.tr();
    }
    return serverError;
  }
  ...
  Widget build(BuildContext context) {
    return AppTextField(
      ...
      label: 'authentication.login_otp.otp_label'.tr(),
      hintText: 'authentication.login_otp.otp_hint'.tr(),
