...
final class _OtpField extends StatelessWidget {
  ...
  String? _validate(String? value) {
    if (value == null || !RegExp(r'^[0-9]{6}$').hasMatch(value)) {
      return 'authentication.forgot_password_otp.validations.otp_invalid_format'.tr();
    }
    return serverError;
  }
  ...
  Widget build(BuildContext context) {
    return AppTextField(
      ...
      label: 'authentication.forgot_password_otp.otp_label'.tr(),
      hintText: 'authentication.forgot_password_otp.otp_hint'.tr(),
