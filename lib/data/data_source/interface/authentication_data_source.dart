...
abstract interface class IAuthenticationDataSource {
  Future<SessionResponse> register({required String email, required String password});

  Future<SessionResponse> login({required String email, required String password});
